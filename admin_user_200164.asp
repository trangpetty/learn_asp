...
<%
    ...
    strSQL = "SELECT COUNT(users.id) as count FROM users"
        ...
        <div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <%
                                ...
                                cmdPrep.CommandText = "SELECT * FROM users ORDER BY users.id OFFSET ?  ROWS FETCH NEXT ? ROWS ONLY"
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    <% if (pages > 1) then %>
                        <% for i = 1 to pages %>
                            <li class='page-item <%=checkPage(Clng(i)=Clng(page),"active")%>''><a class="page-link" href="user_200164.asp?page=<%=i%>"><%=i%></a></li>
                        <% next %>
                    <% end if %>
                </ul>
            </nav>
