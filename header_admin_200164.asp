...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="/admin_200164">Thi CK</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="admin_user_200164.asp">User</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="admin_book_200164.asp">Book</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="addedit_received_200164.asp">Received</a>
                </li>
            </ul>
            <div class="d-flex">
                <%
